...
int main(int argc, char **argv)
{
    ...
    for(int ni=0; ni<nImages; ni++)
    {
        ...
        cv::Mat MaskX = 255*cv::Mat::ones(480,640,CV_8U) - Mask_dil; //255 background y 0 foreground


        // Pass the image to the SLAM system
        SLAM.TrackMonocular(im,MaskX,tframe); //SLAM.TrackMonocular(im,tframe); (Modified by Berta)
