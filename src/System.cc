                          ...
                          cv::Mat &imRGBOut, cv::Mat &imDOut, cv::Mat &maskOut)
{
    ...
    cv::Mat Tcw = mpTracker->GrabImageRGBD(im,depthmap,mask,timestamp,vTimesLightTrack,vTimesFDOD,vTimesBR,imRGBOut,imDOut,maskOut);
                          ...
                          vector<float> &vTimesFDOD, vector<float> &vTimesBR)
{
    ...
    cv::Mat Tcw = mpTracker->GrabImageRGBD(im,depthmap,mask,timestamp,vTimesLightTrack,vTimesFDOD,vTimesBR);
